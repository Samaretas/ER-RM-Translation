...
\subtitle{Taken form prof. Yannis Velegrakis classes}
...
\begin{enumerate}
	...
	\item The third approach is to store all the films in the same table with all the attributes of the parent entity and the children entities, these will be filled with a \texttt{null} value if the film stored isn't a cartoon or a murder.
	\vskip 5pt
